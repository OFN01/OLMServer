...
namespace OLMServer
{
    public class OLMManager
    {
        ...
        {
            return null;    //Book.FromDataSet(new DataSet($"Data/Books/{ID}.dsl"));
        }
        ...
        {
            return null;    //Author.FromDataSet(new DataSet($"Data/Authors/{ID}.dsl"));
        }
        ...
        {
            return null;    //BookSerie.FromDataSet(new DataSet($"Data/BookSeries/{ID}.dsl"));
        }
        ...
        {
            return null;    //Comment.FromDataSet(new DataSet($"Data/Comments/{ID}.dsl"));
        }
        ...
        {
            return null;    //Publisher.FromDataSet(new DataSet($"Data/Publishers/{ID}.dsl"));
        }
        ...
        {
            return null;    //Rating.FromDataSet(new DataSet($"Data/Ratings/{ID}.dsl"));
        }
        ...
        {
            return null; //Rent.FromDataSet(new DataSet($"Data/Rents/{ID}.dsl"));
        }
        ...
        {
            return null;    //StockAsset.FromDataSet(new DataSet($"Data/StockAssets/{ID}.dsl"));
        }
        ...
        {
            return null;    //User.FromDataSet(new DataSet($"Data/Users/{ID}.dsl"));
        }
    }
}